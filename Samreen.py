...
\033[1;32m║AUTHOR       : SAMREEN AHMAD\x1b[1;91m       

\033[1;32m║═══════════════════════════════════════════════════════════║ \x1b[1;91m  

\033[1;32m║WHATSAPP : +923211995357\x1b[1;91m     
...
\033[1;32m║FACEBOOK LINK : \x1b[1;91mhttps://www.facebook.com/fayaz.gul.75457\033[1;32m  

\033[1;32m║═══════════════════════════════════════════════════════════║

\033[1;32m║YouTube LINK  : \x1b[1;91m\033[1;32m    
...
class Main:
	...
	def __init__(self):
		...
		if Talha in ["2", "02"]:
			...
			os.system('xdg-open /https://www.facebook.com/fayaz.gul.75457?mibextid=ZbWKwL')
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;92m   [Samreen_OK] %s | %s\033[0;97m         "%(uid, pw))
				...
				print("\r  \033[91;1m   [Samreen_CP] %s | %s\033[94;1m        "%(uid, pw)) 
